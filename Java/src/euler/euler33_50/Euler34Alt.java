...
// !!alternative Version with ArrayNumber.class!!
...
public class Euler34Alt {
	...
	public static void main(String[] args) {
		...
		ArrayNumber num = new ArrayNumber(10);
		final int[] fac = {1,1,2,6,24,120,720,5_040,40_320,362_880};
		
		int curNum;
		int solution = 0;
		
		 while ( (curNum = num.getNumberAsInt() ) < limit)
		 {
			 if (curNum % fac[9] < 241_920)
			 {			 
				 int facSum = calcFactSum(num.getNumberAsArray(),fac);
